...
if(empty($_SESSION["logId"])==true || $_SESSION["chk"]!="1")
 ...
 if(isset($_REQUEST["Uid"]))
 {
	 //echo "hello";
	 $perid=$_REQUEST["Uid"];
	 $que = "delete from permissions where permissionid = '".$perid."' ";
...
$row=mysqli_fetch_assoc($result);
  ?>
    <tr><td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><?php echo $row["permissionid"]?></td>
 ...
 <td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><a   href="Permission.php?Uid=<?php echo $row["permissionid"];?>" >Edit</a></td>
<td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><a  href="PermissionList.php?Uid=<?php echo $row["permissionid"];?>" onclick="return Confirmation();" >Delete</a></td></tr> 
  <?php } ?>  
   </table>
...
<input type="submit" class="submit" value="Add New Permission" >
</form>
</body>
