...
if(empty($_SESSION["logId"])==true || $_SESSION["chk"]!="1")
 ...
 if(isset($_REQUEST["Uid"]))
 {
	 //echo "hello";
	 $usrid=$_REQUEST["Uid"];
	 $que = "delete from users where userid = '".$usrid."' ";
...
<tr>
    ...
    <th style='width: 100px; color: black; text-align: center; border-collapse: collapse;border:1px solid;height:50px;'>Email</th>
	 <th style='width: 100px; color: black; text-align: center; border-collapse: collapse;border:1px solid;height:50px;'>Created On</th>
	  <th style='width: 100px; color: black; text-align: center; border-collapse: collapse;border:1px solid;height:50px;'>User Type</th>
...
$row=mysqli_fetch_assoc($result);
  ?>
    <tr><td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><?php echo $row["userid"]?></td>
    
    <td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><?php echo $row["name"]?></td>
    <td style='width: 200px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><?php echo $row["email"]?></td>
	...
	<td style='width: 200px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'>Admin</td>
	<?php } else {?>
	<td style='width: 200px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'>Normal User</td> <?php } ?>  
 <td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><a   href="User.php?Uid=<?php echo $row["userid"];?>" >Edit</a></td>
<td style='width: 100px; text-align: center;height:50px; border-collapse: collapse;border:1px solid;'><a  href="UserList.php?Uid=<?php echo $row["userid"];?>" onclick="return Confirmation();" >Delete</a></td></tr> 
  <?php } ?>  
   </table>
